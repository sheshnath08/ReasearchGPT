...
from tools import setup_search_tool, setup_web_extraction_tool, setup_summarization_tool, setup_pdf_extraction_tool
...
def create_research_crew(research_topic, use_memory=True):
    ...
    extraction_tool = setup_web_extraction_tool()
    summarization_tool = setup_summarization_tool()
    pdf_tool = setup_pdf_extraction_tool()
